...
<html lang="vn">
	...
	<body>
		...
		<div class="title" style="margin-left: 120px;"> <img src="img/next.png" alt="Profile  Image" style="width: 40px;"> <h2>Quản lý thông tin sinh viên</h2> </div>

		<div class="info-card">
			<div class="infor-left">
					<img src="img/user.png" alt="Profile  Image">
					<h3><?php echo htmlspecialchars($student_info['TenSV'] ?? "Không có"); ?></h3>
			</div>
			<div class="infor-right">
			<h2><strong>Thông tin sinh viên</strong></h2>
			<table class="info-table">
				<tr>
					<td><strong>Mã sinh viên</strong></td>
					<td><?php echo htmlspecialchars($student_info['MaID'] ?? "Không có"); ?></td>
				</tr>
				<tr>
					<td><strong>Họ tên</strong></td>
					<td><?php echo htmlspecialchars($student_info['TenSV'] ?? "Không có"); ?></td>
				</tr>
				<tr>
					<td><strong>Địa chỉ</strong></td>
					<td><?php echo htmlspecialchars($student_info['DiaChi'] ?? "Không có"); ?></td>
				</tr>
				<tr>
					<td><strong>Ngày sinh</strong></td>
					<td><?php echo htmlspecialchars($student_info['NgaySinh'] ?? "Không có"); ?></td>
				</tr>
				<tr>
					<td><strong>Giới tính</strong></td>
					<td><?php echo htmlspecialchars($student_info['GioiTinh'] ?? "Không có"); ?></td>
				</tr>
				<tr>
					<td><strong>Số điện thoại</strong></td>
					<td><?php echo htmlspecialchars($student_info['SDT'] ?? "Không có"); ?></td>
				</tr>
				<tr>
					<td><strong>Email</strong></td>
					<td><?php echo htmlspecialchars($student_info['Email'] ?? "Không có"); ?></td>
				</tr>
				<tr>
					<td><strong>Lớp hành chính</strong></td>
					<td><?php echo htmlspecialchars($student_info['LopHC'] ?? "Không có"); ?></td>
				</tr>
				<tr>
					<td><strong>Khóa học</strong></td>
					<td><?php echo htmlspecialchars($student_info['KhoaHoc'] ?? "Không có"); ?></td>
				</tr>
				<tr>
					<td><strong>Ngành học</strong></td>
					<td><?php echo htmlspecialchars($student_info['TenKhoa'] ?? "Không có"); ?></td>
				</tr>
				<tr>
					<td><strong>Hình thức đào tạo</strong></td>
					<td><?php echo htmlspecialchars($student_info['HinhThucDT'] ?? "Không có"); ?></td>
				</tr>
			</table>
		</div>
		</div>
